...
if OutFile2:
    while iter1<=LastIter1:
                ...
                if i1%DataCycle1 == 0:
                    ...
                    if i1%ReportLineGranularity1==0:
                        if iter1<=LastIter1:
                            ...
                            LogNote1('Substrate Filtering:',myFileMnemonic1,' Read:',i1//DataCycle1, ' Kept:', NR1, ' SeekingKmers:',len(S2))
        ...
        if iter1<=LastIter1:
            ...
            LogNote1('Finished Filtering:',myFileMnemonic1,' Reads:',TR1, ' Kept:', NR1, ' SoughtKmers:',len(S2))
    ...
    while iter1<=LastIter1:
                ...
                if i1%DataCycle1 == 0:
                    ...
                    if i1%ReportLineGranularity1==0:                    
                        if iter1<=LastIter1:
                            ...
                            LogNote1('Substrate Filtering:',myFileMnemonic1,'(R1only). Read:',i1//DataCycle1, ' Kept:', NR1, ' SeekingKmers:',len(S2))              
                accu1.append(L1)
                if i1%DataCycle1 == 1:
        ...
        if iter1<=LastIter1:
            ...
            LogNote1('Finished Filtering:',myFileMnemonic1,' Reads:',TR1, ' Kepts:', NR1, ' SoughtKmers:',len(S2))
